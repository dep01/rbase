...
import convert_user from "../model/userModel";
...
export const GLOBAL_STATE = {
  loading: true,
  error: null,
  user: convert_user.objectOfuserModel({}),
};
export const MY_GLOBAL_STATE = (data) => {
  let my_state = GLOBAL_STATE;
  my_state = data;
  return my_state;
};
export const GLOBAL_REDUCER = (state = GLOBAL_STATE, action) => {
  switch (action.type) {
    case GLOBAL_ACTION.USER_REQUEST:
      return { ...state, loading: true, error: null };
      break;
    case GLOBAL_ACTION.LOADING_TRUE:
      return { ...state, loading: true };
      break;
    case GLOBAL_ACTION.LOADING_FALSE:
